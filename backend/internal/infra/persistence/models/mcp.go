...
type MCPTool struct {
	ControlPlaneModel
	ServerID        uint   `gorm:"not null;index:idx_mcp_tools_server;uniqueIndex:idx_mcp_tools_server_name;comment:MCP服务ID"`
	Name            string `gorm:"size:128;not null;default:'';uniqueIndex:idx_mcp_tools_server_name;comment:工具名称"`
