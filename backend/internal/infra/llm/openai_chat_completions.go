...
func buildChatCompletionsRequestBody(
	...
	if effort := modelParamString(input.Options, "reasoning_effort"); effort != "" && shouldForwardReasoningEffort(model) {
...
func shouldForwardReasoningEffort(model string) bool {
