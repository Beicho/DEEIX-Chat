...
func defaultSettings() []domainsettings.SystemSetting {
	return []domainsettings.SystemSetting{
		...
		{Namespace: "auth", Key: "invite_registration_required", Value: "false", ValueType: "bool", Description: "邮箱注册是否要求邀请码"},
		...
		{Namespace: "billing", Key: "checkin_reward_nanousd", Value: "10000000", ValueType: "int", Description: "每日签到奖励金额(纳美元)"},
		...
		{Namespace: "billing", Key: "newapi_bridge_base_url", Value: "", ValueType: "string", Description: "NewAPI 桥接服务地址"},
		{Namespace: "billing", Key: "newapi_bridge_hmac_key", Value: "", ValueType: "string", Description: "NewAPI 桥接 HMAC 密钥"},
		...
		{Namespace: "storage", Key: "max_message_files", Value: "30", ValueType: "int", Description: "单消息附件数"},
		...
		{Namespace: "extract", Key: "pdf_ocr_fallback_enabled", Value: "true", ValueType: "bool", Description: "PDF 原生文本提取失败或质量较差时是否启用 OCR 回退"},
		...
		{Namespace: "mcp", Key: "mcp_tool_timeout_seconds", Value: "60", ValueType: "int", Description: "MCP Tool Call 超时(秒)"},
		...
		{Namespace: "mcp", Key: "web_search_provider", Value: "disabled", ValueType: "string", Description: "平台联网搜索提供方(disabled/searxng/tavily/bocha)"},
		{Namespace: "mcp", Key: "web_search_base_url", Value: "", ValueType: "string", Description: "平台联网搜索服务地址"},
		{Namespace: "mcp", Key: "web_search_api_key", Value: "", ValueType: "string", Description: "平台联网搜索 API Key"},
		{Namespace: "mcp", Key: "web_search_timeout_seconds", Value: "30", ValueType: "int", Description: "平台联网搜索请求超时(秒)"},
		{Namespace: "mcp", Key: "web_search_max_results", Value: "5", ValueType: "int", Description: "平台联网搜索默认结果数"},
		{Namespace: "mcp", Key: "code_sandbox_enabled", Value: "false", ValueType: "bool", Description: "启用平台代码运行工具"},
		{Namespace: "mcp", Key: "code_sandbox_timeout_seconds", Value: "5", ValueType: "int", Description: "代码运行超时(秒)"},
		{Namespace: "mcp", Key: "code_sandbox_max_code_chars", Value: "12000", ValueType: "int", Description: "代码运行输入最大字符数"},
		{Namespace: "mcp", Key: "code_sandbox_max_output_chars", Value: "12000", ValueType: "int", Description: "代码运行输出最大字符数"},

		// 语音配置
		{Namespace: "voice", Key: "asr_enabled", Value: "false", ValueType: "bool", Description: "启用服务端语音转写"},
		{Namespace: "voice", Key: "asr_provider", Value: "disabled", ValueType: "string", Description: "语音转写提供方"},
		{Namespace: "voice", Key: "asr_model", Value: "", ValueType: "string", Description: "语音转写模型"},
		{Namespace: "voice", Key: "tts_enabled", Value: "false", ValueType: "bool", Description: "启用服务端朗读合成"},
		{Namespace: "voice", Key: "tts_provider", Value: "disabled", ValueType: "string", Description: "朗读合成提供方"},
		{Namespace: "voice", Key: "tts_model", Value: "", ValueType: "string", Description: "朗读合成模型"},
		{Namespace: "voice", Key: "tts_voice", Value: "", ValueType: "string", Description: "朗读音色"},

		// 内容检查与公开状态通知
		{Namespace: "moderation", Key: "enabled", Value: "false", ValueType: "bool", Description: "启用外部内容检查"},
		{Namespace: "moderation", Key: "mode", Value: "moderations", ValueType: "string", Description: "内容检查模式"},
		{Namespace: "moderation", Key: "fail_strategy", Value: "fail_open", ValueType: "string", Description: "检查失败处理策略"},
		{Namespace: "moderation", Key: "base_url", Value: "", ValueType: "string", Description: "OpenAI 兼容内容检查服务地址"},
		{Namespace: "moderation", Key: "api_key", Value: "", ValueType: "string", Description: "内容检查服务 API Key"},
		{Namespace: "moderation", Key: "model", Value: "omni-moderation-latest", ValueType: "string", Description: "内容检查模型"},
		{Namespace: "moderation", Key: "threshold", Value: "0.5", ValueType: "string", Description: "内容检查命中阈值"},
		{Namespace: "moderation", Key: "action", Value: "block", ValueType: "string", Description: "命中后的处理动作"},
		{Namespace: "moderation", Key: "timeout_seconds", Value: "30", ValueType: "int", Description: "内容检查超时时间"},
		{Namespace: "moderation", Key: "classifier_template", Value: "", ValueType: "string", Description: "聊天分类器系统提示词模板"},
		{Namespace: "moderation", Key: "auto_window_hours", Value: "24", ValueType: "int", Description: "自动处置统计窗口"},
		{Namespace: "moderation", Key: "auto_limit_threshold", Value: "0", ValueType: "int", Description: "自动限制阈值，0 表示关闭"},
		{Namespace: "moderation", Key: "auto_suspend_threshold", Value: "0", ValueType: "int", Description: "自动暂停阈值，0 表示关闭"},
		{Namespace: "moderation", Key: "auto_limit_rpm", Value: "5", ValueType: "int", Description: "自动限制后的每分钟请求数"},
		{Namespace: "moderation", Key: "auto_limit_duration_minutes", Value: "60", ValueType: "int", Description: "自动限制持续分钟数"},
		{Namespace: "moderation", Key: "output_window_chars", Value: "800", ValueType: "int", Description: "流式输出检查窗口字符数"},
		{Namespace: "status", Key: "notifier_enabled", Value: "false", ValueType: "bool", Description: "启用模型状态通知"},
		{Namespace: "status", Key: "notifier_webhook_url", Value: "", ValueType: "string", Description: "状态通知 Webhook 地址"},
		{Namespace: "status", Key: "notifier_email", Value: "", ValueType: "string", Description: "状态通知邮箱"},
