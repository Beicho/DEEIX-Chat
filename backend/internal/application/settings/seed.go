...
func defaultSettings() []domainsettings.SystemSetting {
	return []domainsettings.SystemSetting{
		...
		{Namespace: "mcp", Key: "web_search_timeout_seconds", Value: "10", ValueType: "int", Description: "平台联网搜索请求超时(秒)"},
		...
		{Namespace: "moderation", Key: "timeout_seconds", Value: "10", ValueType: "int", Description: "内容检查超时时间"},
