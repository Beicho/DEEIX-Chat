...
// ListRedemptionLogs 查询管理员兑换记录列表。
func (s *Service) ListRedemptionLogs(ctx context.Context, page int, pageSize int, filter RedemptionListFilter) ([]RedemptionRecordView, int64, error) {
	offset, limit := normalizePage(page, pageSize)
	records, total, err := s.repo.ListRedemptionRecords(ctx, repository.RedemptionListFilter{
