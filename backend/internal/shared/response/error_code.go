...
var exactErrorSpecs = map[string]errorSpec{
	...
	"smtp is not configured":                                                {Code: "auth.smtp_not_configured", Message: "smtp is not configured"},
	"invite code is required":                                               {Code: "auth.invite_code_required", Message: "invite code is required"},
	...
	"message delete state invalid":                            {Code: "message.delete_state_invalid", Message: "message delete state invalid"},
	...
	"invitation code is required":                                  {Code: "auth.invitation_required", Message: "invitation code is required"},
	"invitation code is invalid":                                   {Code: "auth.invitation_invalid", Message: "invitation code is invalid"},
	"pending registration is invalid":                              {Code: "auth.pending_registration_invalid", Message: "registration session expired"},
	"usage balance is insufficient":                                {Code: CodeBillingInsufficientFunds, Message: "insufficient balance"},
	"call cost is not covered by available credit":                 {Code: "billing.cost_not_covered", Message: "insufficient balance for this model"},
	"new user cooldown is active":                                  {Code: "billing.new_user_cooldown", Message: "this model is unavailable for new accounts"},
	"daily spend limit exceeded":                                   {Code: "billing.daily_spend_limit", Message: "daily spend limit reached"},
	"concurrent generation limit exceeded":                         {Code: "billing.concurrent_limit", Message: "too many generations in progress"},
...
var fallbackMessages = map[string]string{
	...
	"auth.smtp_not_configured":                        "smtp is not configured",
	"auth.invite_code_required":                       "invite code is required",
	"auth.invite_code_invalid":                        "invite code is invalid or exhausted",
	"auth.email_code_login_disabled":                  "email code login is disabled",
